...
contract BlindAuction {
  ...
  mapping(uint8 => UnsealedBid) public tokenIdToHighestUnsealedBid;
  ...
  function hashBid(uint8 tokenId, uint256 amount, address bidder) public pure returns (bytes32) {
  ...
  function unsealBid(uint8 tokenId, uint256 amount) external payable nonReentrant {
  ...
  function claimToken(uint8 tokenId) external {
